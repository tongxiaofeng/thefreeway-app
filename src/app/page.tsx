...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* Nav */}
      <nav className="flex items-center justify-between px-6 md:px-20 h-20 bg-dark">
      ...
      {/* Hero */}
      <section className="bg-dark px-6 md:px-[120px] pt-16 md:pt-[100px] pb-16 md:pb-20">
      ...
      {/* Problem Section */}
      <section className="bg-cream px-6 md:px-[120px] py-16 md:py-[100px]">
      ...
      <section
        id="method"
        className="bg-dark px-6 md:px-[120px] py-16 md:py-[100px]"
      >
        <div className="flex flex-col gap-12 md:gap-[60px]">
          <div className="flex flex-col gap-4">
            <span className="text-olive text-xs font-semibold tracking-[3px]">
      ...
      <section
        id="story"
        className="bg-cream px-6 md:px-[120px] py-16 md:py-[100px]"
      >
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-[60px]">
          ...
          <div className="flex flex-col items-center gap-6 w-full md:w-[300px] shrink-0">
            ...
            <div className="flex gap-4 w-full">
              ...
              <div className="flex flex-col items-center gap-1 flex-1">
                <span className="font-mono text-foreground text-xl">94%</span>
      ...
      <section
        id="cta"
        className="bg-dark px-6 md:px-[120px] py-16 md:py-[120px] flex flex-col items-center gap-8"
      >
      ...
      <footer
        id="pricing"
        className="bg-dark border-t border-[#1a1a1a] px-6 md:px-[120px] pt-[60px] pb-10 flex flex-col md:flex-row justify-between gap-10"
      >
